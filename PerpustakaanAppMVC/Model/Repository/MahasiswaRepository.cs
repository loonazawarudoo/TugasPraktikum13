...
namespace PerpustakaanAppMVC.Model.Repository
{
    public class MahasiswaRepository
    {
        ...
        // Method untuk menampilkan data mahasiwa berdasarkan angkatan
        public Mahasiswa ReadByAngkatan(string angkatan)
        {
            // membuat objek mahasiswa
            Mahasiswa mhs = null;
            ...
            {
                System.Diagnostics.Debug.Print("ReadByAngkatan error: {0}", ex.Message);
            }
